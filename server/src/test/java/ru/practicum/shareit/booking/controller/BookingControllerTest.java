...
class BookingControllerTest {
    ...
    @Test
    void findByParam() {
        when(bookingService.findAllByParam(anyLong(), any(BookingStatus.class), any(Pageable.class)))
        ...
        verify(bookingService, times(1))
                .findAllByParam(anyLong(), any(BookingStatus.class), any(Pageable.class));
    }

    @SneakyThrows
    @Test
    void findByOwner() {
        when(bookingService.findAllByOwner(anyLong(), any(BookingStatus.class), any(Pageable.class)))
                .thenReturn(Collections.singletonList(bookingDto));
        ...
        mvc.perform(get("/bookings/owner")
                ...
                .andExpect(jsonPath("$", hasSize(1)));
        verify(bookingService, times(1))
                .findAllByOwner(anyLong(), any(BookingStatus.class), any(Pageable.class));
    }
}