...
public interface BookingService {
    ...
    List<BookingDto> findAllByParam(long userId, String state, Integer from, Integer size);

    List<BookingDto> findAllByOwner(long userId, String state, Integer from, Integer size);
}
